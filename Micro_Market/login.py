...
class Login(tk.Frame):
    ...
    def __init__(self, padre, controlador):
        ...
        self.logo_image = Image.open("Iconos/user1.png")  # Cargar el logo del usuario
        self.logo_image = self.logo_image.resize((100, 100))  # Ajustar tamaño
    ...
    def show_login_interface(self):   
        ...
        frame1 = tk.Frame(self, bg="light gray", highlightbackground="black", highlightthickness=1)
        frame1.place(x=350, y=70, width=350, height=525)

        # Añadir logo del usuario en la parte superior
        logo_label = tk.Label(frame1, image=self.logo_image, bg="#C6D9E3")
        logo_label.image = self.logo_image
        logo_label.place(x=125, y=90, width=120, height=120)
